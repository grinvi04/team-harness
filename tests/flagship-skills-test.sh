...
check_contains "plugin manifest v0.59.0" "$MANIFEST" '"version": "0\.59\.0"'
check_contains "manifest가 두 대표 스킬을 설명" "$MANIFEST" \
  'systematic-debugging.*verification-before-completion'
check_contains "README badge v0.59.0" "$README" 'harness--guard_v0\.59\.0'
...
check_contains "소개 페이지 v0.59.0" "$INTRO" 'harness-guard v0\.59\.0'
