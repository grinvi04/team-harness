...
DEBUG_WRAPPER="$ROOT/plugins/harness-guard/codex/skills/systematic-debugging/SKILL.md"

echo "=== systematic-debugging ==="
check_file "skill manifest 발견" "$DEBUG_SKILL"
check_file "Codex UI metadata 발견" "$DEBUG_UI"
check_file "Codex native wrapper 발견" "$DEBUG_WRAPPER"
...
check_contains "Codex 실행 의미는 native wrapper에 격리" "$DEBUG_WRAPPER" '^## Codex 실행$'
...
VERIFY_WRAPPER="$ROOT/plugins/harness-guard/codex/skills/verification-before-completion/SKILL.md"

echo ""
echo "=== verification-before-completion ==="
check_file "skill manifest 발견" "$VERIFY_SKILL"
check_file "Codex UI metadata 발견" "$VERIFY_UI"
check_file "Codex native wrapper 발견" "$VERIFY_WRAPPER"
...
check_contains "Codex 실행 의미는 native wrapper에 격리" "$VERIFY_WRAPPER" '^## Codex 실행$'
